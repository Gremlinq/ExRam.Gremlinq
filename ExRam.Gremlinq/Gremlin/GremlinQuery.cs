...
namespace ExRam.Gremlinq
{
        ...
        IEGremlinQuery<TElement, TOutVertex, TInVertex>
    {
            ...
            where TTargetQuery : IGremlinQuery
        {
            ...
            return continuation(
                AddStep<TElement>(new MethodStep.MethodStepN("aggregate", stepLabel)),
                stepLabel);
        }
        #endregion
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> As(StepLabel<TElement> stepLabel) => AddStep<TElement>(new MethodStep.MethodStepN("as", stepLabel));
        #endregion

        IGremlinQuery<TElement> IGremlinQuery<TElement>.Barrier() => AddStep<TElement>(new MethodStep.MethodStepN("barrier"));
        ...
        private TTargetQuery Coalesce<TTargetQuery>(params Func<GremlinQueryImpl<TElement, TOutVertex, TInVertex>, TTargetQuery>[] traversals)
            where TTargetQuery : IGremlinQuery
        {
            return this.AddStep<TElement>(new MethodStep.MethodStepN("coalesce", traversals
        ...
        IGremlinQuery<long> IGremlinQuery.Count() => AddStep<long>(new MethodStep.MethodStepN("count"));
        ...
        IGremlinQuery<TResult> IGremlinQuery<TElement>.Choose<TResult>(Func<IGremlinQuery<TElement>, IGremlinQuery> traversalPredicate, Func<IGremlinQuery<TElement>, IGremlinQuery<TResult>> trueChoice)
        {
            ...
            return AddStep<TResult>(new MethodStep.MethodStepN("choose", traversalPredicate(anonymous), trueChoice(anonymous)));
        }
        #endregion
        ...
        IVGremlinQuery<Vertex> IEGremlinQuery<TElement>.BothV() => AddStep<Vertex>(new MethodStep.MethodStepN("bothV"));
        #endregion
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Dedup() => AddStep<TElement>(new MethodStep.MethodStepN("dedup"));
        #endregion

        IGremlinQuery<Unit> IGremlinQuery.Drop() => AddStep<Unit>(new MethodStep.MethodStepN("drop"));

        IEGremlinQuery<Edge> IGremlinQuery.E(params object[] ids) => AddStep<Edge>(new MethodStep.MethodStepN("E", ids));
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Emit() => AddStep<TElement>(new MethodStep.MethodStepN("emit"));
        #endregion

        IGremlinQuery<string> IGremlinQuery.Explain() => AddStep<string>(new MethodStep.MethodStepN("explain"));

        IGremlinQuery<TElement> IGremlinQuery<TElement>.Filter(string lambda) => AddStep<TElement>(new MethodStep.MethodStepN("filter", new Lambda(lambda)));

        IGremlinQuery<TElement[]> IGremlinQuery<TElement>.Fold() => AddStep<TElement[]>(new MethodStep.MethodStepN("fold"));

        #region From (step label)
        IOutEGremlinQuery<TElement, TNewOutVertex> IEGremlinQuery<TElement>.From<TNewOutVertex>(StepLabel<TNewOutVertex> stepLabel) => AddStep<TElement, TNewOutVertex, Unit>(new MethodStep.MethodStepN("from", stepLabel));

        IEGremlinQuery<TElement, TTargetVertex, TOutVertex> IEGremlinQuery<TElement, TOutVertex>.From<TTargetVertex>(StepLabel<TTargetVertex> stepLabel) => AddStep<TElement, TTargetVertex, TOutVertex>(new MethodStep.MethodStepN("from", stepLabel));
        #endregion

        #region From (traversal)
        IEGremlinQuery<TElement, TTargetVertex, TOutVertex> IEGremlinQuery<TElement, TOutVertex>.From<TTargetVertex>(Func<IVGremlinQuery<TOutVertex>, IGremlinQuery<TTargetVertex>> fromVertexTraversal) => AddStep<TElement, TTargetVertex, TOutVertex>(new MethodStep.MethodStepN("from", fromVertexTraversal(GremlinQueryImpl<TOutVertex, Unit, Unit>.Anonymous)));
        ...
        private GremlinQueryImpl<TNewElement, TNewOutVertex, TNewInVertex> From<TNewElement, TNewOutVertex, TNewInVertex>(Func<GremlinQueryImpl<TElement, TOutVertex, TInVertex>, IGremlinQuery> fromVertexTraversal) => AddStep<TNewElement, TNewOutVertex, TNewInVertex>(new MethodStep.MethodStepN("from", fromVertexTraversal(Anonymous)));
        #endregion

        IGremlinQuery<object> IGremlinQuery.Id() => AddStep<object>(new MethodStep.MethodStepN("id"));
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Identity() => AddStep<TElement>(new MethodStep.MethodStepN("identity"));
        #endregion
        ...
        #region InV
        IVGremlinQuery<Vertex> IEGremlinQuery<TElement>.InV() => AddStep<Vertex, Unit, Unit>(new MethodStep.MethodStepN("inV"));

        IVGremlinQuery<TInVertex> IEGremlinQuery<TElement, TOutVertex, TInVertex>.InV() => AddStep<TInVertex, Unit, Unit>(new MethodStep.MethodStepN("inV"));

        IVGremlinQuery<TInVertex> IInEGremlinQuery<TElement, TInVertex>.InV() => AddStep<TInVertex, Unit, Unit>(new MethodStep.MethodStepN("inV"));
        #endregion

        IGremlinQuery<TElement> IGremlinQuery<TElement>.Inject(params TElement[] elements) => AddStep<TElement>(new MethodStep.MethodStepN("inject", elements.Cast<object>().ToArray()));
        ...
        private TTargetQuery Local<TTargetQuery>(Func<GremlinQueryImpl<TElement, TOutVertex, TInVertex>, TTargetQuery> localTraversal)
            where TTargetQuery : IGremlinQuery
        {
            return this.AddStep<TElement>(new MethodStep.MethodStepN("local", localTraversal(Anonymous)))
                .CastQuery<TTargetQuery>();
        }
        #endregion
        ...
        {
            return this.AddStep<TElement>(new MethodStep.MethodStepN("map", mapping(Anonymous)))
                .CastQuery<TTargetQuery>();
        }
        #endregion

        // ReSharper disable once CoVariantArrayConversion
        IGremlinQuery<TElement> IGremlinQuery<TElement>.Match(params Func<IGremlinQuery<TElement>, IGremlinQuery<TElement>>[] matchTraversals) => AddStep<TElement>(new MethodStep.MethodStepN("match", matchTraversals.Select(traversal => traversal(Anonymous)).ToArray<object>()));
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Optional(Func<GremlinQueryImpl<TElement, TOutVertex, TInVertex>, IGremlinQuery> optionalTraversal) => AddStep<TElement>(new MethodStep.MethodStepN("optional", optionalTraversal(Anonymous)));
        #endregion
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> OrderBy(Expression<Func<TElement, object>> projection, Order order)
        {
            ...
            {
                return this.AddStep<TElement>(new MethodStep.MethodStepN("order")).AddStep<TElement>(new MethodStep.MethodStepN("by", memberExpression.Member.Name, order));
            }
        ...
        {
            return this.AddStep<TElement>(new MethodStep.MethodStepN("order")).AddStep<TElement>(new MethodStep.MethodStepN("by", traversal(Anonymous), order));
        }
        #endregion
        ...
        {
            return this.AddStep<TElement>(new MethodStep.MethodStepN("order")).AddStep<TElement>(new MethodStep.MethodStepN("by", new Lambda(lambda)));
        }
        #endregion

        IVGremlinQuery<Vertex> IEGremlinQuery<TElement>.OtherV() => AddStep<Vertex>(new MethodStep.MethodStepN("otherV"));
        ...
        IVGremlinQuery<Vertex> IEGremlinQuery<TElement>.OutV() => AddStep<Vertex, Unit, Unit>(new MethodStep.MethodStepN("outV"));
        
        IVGremlinQuery<TOutVertex> IEGremlinQuery<TElement, TOutVertex, TInVertex>.OutV() => AddStep<TOutVertex, Unit, Unit>(new MethodStep.MethodStepN("outV"));

        IVGremlinQuery<TOutVertex> IOutEGremlinQuery<TElement, TOutVertex>.OutV() => AddStep<TOutVertex, Unit, Unit>(new MethodStep.MethodStepN("outV"));

        IVGremlinQuery<Vertex> IVGremlinQuery<TElement>.Out<TNewEdge>() => AddStep<Vertex>(new DerivedLabelNamesStep<TNewEdge>("out"));
        #endregion
        
        IGremlinQuery<string> IGremlinQuery.Profile() => AddStep<string>(new MethodStep.MethodStepN("profile"));
        ...
        {
            return AddStep<Property, Unit, Unit>(new MethodStep.MethodStepN("properties", keys.ToArray<object>()));
        }

        private GremlinQueryImpl<VertexProperty, Unit, Unit> Properties(params Expression<Func<TElement, object>>[] projections)
        {
            return AddStep<VertexProperty, Unit, Unit>(new MethodStep.MethodStepN("properties", projections
                .Select(projection =>
                {
                    if (projection.Body.StripConvert() is MemberExpression memberExpression)
                    {
        ...
        {
            return AddStep<TElement>(new MethodStep.MethodStepN("property", key, value));
        }
        #endregion
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Range(long low, long high)
        {
            ...
            return AddStep<TElement>(new MethodStep.MethodStepN("range", (int)low, (int)high));
        }
        #endregion
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Repeat(Func<GremlinQueryImpl<TElement, TOutVertex, TInVertex>, IGremlinQuery> repeatTraversal) => AddStep<TElement>(new MethodStep.MethodStepN("repeat", repeatTraversal(Anonymous)));
        #endregion
        ...
        {
            return this.AddStep<TElement>(new MethodStep.MethodStepN("repeat", repeatTraversal(Anonymous))).AddStep<TElement>(new MethodStep.MethodStepN("until", untilTraversal(Anonymous)));
        }
        #endregion
        ...
        private GremlinQueryImpl<TSelectedElement, TSelectedOutVertex, TSelectedInVertex> Select<TSelectedElement, TSelectedOutVertex, TSelectedInVertex>(StepLabel<TSelectedElement> stepLabel) => AddStep<TSelectedElement, TSelectedOutVertex, TSelectedInVertex>(new MethodStep.MethodStepN("select", stepLabel));

        IGremlinQuery<(T1, T2)> IGremlinQuery.Select<T1, T2>(StepLabel<T1> label1, StepLabel<T2> label2)
        {
            return this.AddStep<(T1, T2)>(new MethodStep.MethodStepN("select", label1, label2))
        ...
        {
            return this.AddStep<(T1, T2, T3, T4)>(new MethodStep.MethodStepN("select", label1, label2, label3, label4))
                .AddStepLabelBinding(x => x.Item1, label1)
                .AddStepLabelBinding(x => x.Item2, label2)
                .AddStepLabelBinding(x => x.Item3, label3)
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> SideEffect(Func<GremlinQueryImpl<TElement, TOutVertex, TInVertex>, IGremlinQuery> sideEffectTraversal) => AddStep<TElement>(new MethodStep.MethodStepN("sideEffect", sideEffectTraversal(Anonymous)));
        #endregion
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Skip(long skip)
        {
            ...
            return AddStep<TElement>(new MethodStep.MethodStepN("skip", (int)skip));
        }

        #endregion

        #region Sum
        IGremlinQuery<TElement> IGremlinQuery<TElement>.SumLocal() => AddStep<TElement>(new MethodStep.MethodStepN("sum", Scope.Local));

        IGremlinQuery<TElement> IGremlinQuery<TElement>.SumGlobal() => AddStep<TElement>(new MethodStep.MethodStepN("sum", Scope.Global));
        #endregion

        IGremlinQuery<TElement> IGremlinQuery<TElement>.Times(int count) => AddStep<TElement>(new MethodStep.MethodStepN("times", count));
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Tail(long limit)
        {
            ...
            return AddStep<TElement>(new MethodStep.MethodStepN("tail", (int)limit));
        }
        #endregion

        #region To (step label)
        IInEGremlinQuery<TElement, TNewInVertex> IEGremlinQuery<TElement>.To<TNewInVertex>(StepLabel<TNewInVertex> stepLabel) => AddStep<TElement, Unit, TNewInVertex>(new MethodStep.MethodStepN("to", stepLabel));

        IEGremlinQuery<TElement, TOutVertex, TTargetVertex> IEGremlinQuery<TElement, TOutVertex>.To<TTargetVertex>(StepLabel<TTargetVertex> stepLabel) => AddStep<TElement, TOutVertex, TTargetVertex>(new MethodStep.MethodStepN("to", stepLabel));
        #endregion

        #region To (traversal)
        IEGremlinQuery<TElement, TOutVertex, TTargetVertex> IEGremlinQuery<TElement, TOutVertex>.To<TTargetVertex>(Func<IVGremlinQuery<TOutVertex>, IGremlinQuery<TTargetVertex>> toVertexTraversal) => AddStep<TElement, TOutVertex, TTargetVertex>(new MethodStep.MethodStepN("to", toVertexTraversal(GremlinQueryImpl<TOutVertex, Unit, Unit>.Anonymous)));
        ...
        private GremlinQueryImpl<TNewElement, TNewOutVertex, TNewInVertex> To<TNewElement, TNewOutVertex, TNewInVertex>(Func<GremlinQueryImpl<TElement, TOutVertex, TInVertex>, IGremlinQuery> toVertexTraversal) => AddStep<TNewElement, TNewOutVertex, TNewInVertex>(new MethodStep.MethodStepN("to", toVertexTraversal(Anonymous)));
        #endregion

        IGremlinQuery<TItem> IGremlinQuery<TElement>.Unfold<TItem>()
        {
            return AddStep<TItem>(new MethodStep.MethodStepN("unfold"));
        }
        ...
        IVGremlinQuery<Vertex> IGremlinQuery.V(params object[] ids) => AddStep<Vertex>(new MethodStep.MethodStepN("V", ids));
        ...
        IGremlinQuery<TElement> IGremlinQuery<TElement>.Where(Func<IGremlinQuery<TElement>, IGremlinQuery> filterTraversal) => AddStep<TElement>(new MethodStep.MethodStepN("where", filterTraversal(Anonymous)));
        ...
        private GremlinQueryImpl<TElement, TOutVertex, TInVertex> Where(Func<GremlinQueryImpl<TElement, TOutVertex, TInVertex>, IGremlinQuery> filterTraversal) => AddStep<TElement>(new MethodStep.MethodStepN("where", filterTraversal(Anonymous)));
        #endregion
            ...
            else
            {
                ...
                switch (left)
                {
                        ...
                        return AddStep(new HasStep(
                            ...
                            rightConstant is StepLabel
                                ? (IGremlinQuery<Unit>) GremlinQuery
                                    .Anonymous.AddStep(new MethodStep.MethodStepN("where", predicateArgument))
                    ...
                    case ParameterExpression leftParameterExpression when parameter == leftParameterExpression:
                    {
                        return AddStep(
                            rightConstant is StepLabel
                                ? new MethodStep.MethodStepN("where", predicateArgument)
    ...
    public static class GremlinQuery
    {
        ...
        public static IGremlinQuery<Unit> WithSubgraphStrategy(this IGremlinQuery<Unit> query, Func<IGremlinQuery<Unit>, IGremlinQuery> vertexCriterion, Func<IGremlinQuery<Unit>, IGremlinQuery> edgeCriterion)
        {
            ...
            {
                var strategy = (IGremlinQuery<Unit>) Create("SubgraphStrategy").AddStep(new MethodStep.MethodStepN("build"));

                if (vertexCriterionTraversal.Steps.Count > 0)
                {
                    strategy = strategy.AddStep(new MethodStep.MethodStepN("vertices", vertexCriterionTraversal));
                }

                if (edgeCriterionTraversal.Steps.Count > 0)
                {
                    strategy = strategy.AddStep(new MethodStep.MethodStepN("edges", edgeCriterionTraversal));
                }

                return query.AddStep(new MethodStep.MethodStepN("withStrategies", (IGremlinQuery<Unit>) strategy.AddStep(new MethodStep.MethodStepN("create"))));
            }
