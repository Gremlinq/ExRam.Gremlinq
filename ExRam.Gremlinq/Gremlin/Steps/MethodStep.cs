...
namespace ExRam.Gremlinq
{
    public abstract class MethodStep : TerminalStep
    {
        ...
        public static readonly MethodStep SumLocal = MethodStep.Create("sum", Scope.Local);
        public static readonly MethodStep SumGlobal = MethodStep.Create("sum", Scope.Global);
