...
namespace ExRam.Gremlinq.Core.Tests
{
    public static class JTokenExtensions
    {
        ...
        {
            return jProperty.Name.Equals("id", StringComparison.OrdinalIgnoreCase) || jProperty.Name.Equals("relationId", StringComparison.OrdinalIgnoreCase)
                ? new(jProperty.Name, "scrubbed Id")
                : new(jProperty.Name, jProperty.Value.Canonicalize());
        }
    }
}
