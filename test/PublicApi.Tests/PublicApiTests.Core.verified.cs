...
namespace ExRam.Gremlinq.Core
{
    ...
    public interface IGremlinQueryStrategy<TStrategyBuilder, TStrategy> : ExRam.Gremlinq.Core.IGremlinQueryStrategy
        where TStrategyBuilder : ExRam.Gremlinq.Core.IGremlinQueryStrategyBuilder<TStrategy>
        where TStrategy : ExRam.Gremlinq.Core.IGremlinQueryStrategy<TStrategyBuilder, TStrategy>
    {
        TStrategyBuilder Build();
    }
