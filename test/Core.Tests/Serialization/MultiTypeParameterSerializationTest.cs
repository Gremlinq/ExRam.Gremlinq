...
namespace ExRam.Gremlinq.Core.Tests
{
    public class MultiTypeParameterSerializationTest : GremlinqTestBase, IClassFixture<GremlinqFixture>
    {
        ...
        [Fact]
        public virtual Task In_without_type() => _g
            .V<Person>()
            .In()
            .Verify();

        [Fact]
        public virtual Task In_with_one_object_type() => _g
            .V<Person>()
            .In<object>()
            .Verify();

        [Fact]
        public virtual Task In_with_one_type() => _g
            .V<Person>()
            .In<Edge1>()
            .Verify();
        ...
        [Fact]
        public virtual Task Out_without_object_type() => _g
            .V<Person>()
            .Out()
            .Verify();

        [Fact]
        public virtual Task Out_with_one_object_type() => _g
            .V<Person>()
            .Out<object>()
            .Verify();

        [Fact]
        public virtual Task Out_with_one_type() => _g
            .V<Person>()
            .Out<Edge1>()
            .Verify();
        ...
        [Fact]
        public virtual Task Both_without_type() => _g
            .V<Person>()
            .Both()
            .Verify();

        [Fact]
        public virtual Task Both_with_one_object_type() => _g
            .V<Person>()
            .Both<object>()
            .Verify();

        [Fact]
        public virtual Task Both_with_one_type() => _g
            .V<Person>()
            .Both<Edge1>()
            .Verify();
