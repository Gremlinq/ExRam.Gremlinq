...
namespace ExRam.Gremlinq.Core.Tests
{
    public class QueryAssertions
    {
        ...
        [Fact]
        public virtual async Task Coalesce_empty() => _g
            .V()
        ...
        [Fact]
        public virtual async Task Limit_underflow() => _g
            .V()
        ...
        [Fact]
        public virtual void Range_underflow() => _g
            .V()
        ...
        [Fact]
        public virtual async Task Select_with_unknown_label_throws() => _g
            .Inject(0)
            .Invoking(_ => _
                .Select<int>("label"))
            .Should()
        ...
        [Fact]
        public virtual void Skip_underflow() => _g
            .V()
            .Invoking(_ => _.Skip(-1))
            .Should()
            .Throw<ArgumentException>();
        ...
        [Fact]
        public virtual void Tail_underflow() => _g
            .V()
            .Invoking(_ => _.Tail(-1))
            .Should()
            .Throw<ArgumentException>();
        ...
        [Fact]
        public virtual void Where_property_contains_constant_without_TextP_support() => _g
        ...
        [Fact]
        public virtual async Task Where_property_ends_with_constant_without_TextP_support() => _g
            .ConfigureEnvironment(env => env
                .ConfigureOptions(c => c
