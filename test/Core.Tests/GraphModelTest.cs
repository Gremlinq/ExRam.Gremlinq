    ...
    public class GraphModelTest
    {
        ...
        public async Task GetFilterLabels_does_not_include_abstract_type()
        {
            ...
            await Verify(model.VerticesModel
                .GetFilterLabels(TypeArrayCache<Authority>.Types.Types!, FilterLabelsVerbosity.Maximum));
        }
        ...
        public async Task Non_abstract_base_types_are_included()
        {
            var a = GraphModel
                ...
                .VerticesModel
                .GetFilterLabels(TypeArrayCache<NonAbstractBaseVertex>.Types.Types!, FilterLabelsVerbosity.Maximum);
