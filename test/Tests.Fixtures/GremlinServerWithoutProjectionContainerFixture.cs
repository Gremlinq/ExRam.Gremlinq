...
{
    public sealed class GremlinServerWithoutProjectionContainerFixture : ImageTestContainerFixture
    {
        public GremlinServerWithoutProjectionContainerFixture() : base("tinkerpop/gremlin-server:3.7.2")
        {
        }
