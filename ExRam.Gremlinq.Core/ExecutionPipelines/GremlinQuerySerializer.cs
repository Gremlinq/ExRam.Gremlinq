    ...
    public static class GremlinQuerySerializer
    {
        ...
        public static IGremlinQuerySerializer UseDefaultGremlinStepSerializationHandlers(this IGremlinQuerySerializer serializer)
        {
            return serializer
                ...
                .OverrideFragmentSerializer<AggregateStep>((step, overridden, recurse) => CreateInstruction("aggregate", recurse, step.Scope, step.StepLabel))
                ...
                .OverrideFragmentSerializer<MaxStep>((step, overridden, recurse) => CreateInstruction("max", recurse, step.Scope))
                ...
                .OverrideFragmentSerializer<MeanStep>((step, overridden, recurse) => CreateInstruction("mean", recurse, step.Scope))
                .OverrideFragmentSerializer<MinStep>((step, overridden, recurse) => CreateInstruction("min", recurse, step.Scope))
