...
namespace ExRam.Gremlinq.Core
{
        ...
        IOrderedPropertyGremlinQuery<TElement>
    {
        ...
        IGremlinQuery IGremlinQueryAdmin.ConfigureSteps(Func<IImmutableList<Step>, IImmutableList<Step>> configurator) => new GremlinQuery<Unit, Unit, Unit, Unit, Unit, Unit>(configurator(Steps), Environment, true);
