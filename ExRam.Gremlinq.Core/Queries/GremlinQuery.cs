...
#pragma warning restore CS8601 // Possible null reference assignment.
        ...
        {
            return this
                .AddStep<TEdge, TElement, object, object, object, object>(new AddEStep(Environment.GetCache().EdgesModelCache.GetLabel(newEdge!.GetType())), QuerySemantics.Edge)
        ...
        {
            return this
                .AddStepWithObjectTypes<TVertex>(new AddVStep(Environment.GetCache().VerticesModelCache.GetLabel(vertex!.GetType())), QuerySemantics.Vertex)
