...
namespace ExRam.Gremlinq.Core
{
        ...
        IOrderedEGremlinQuery<TElement, TOutVertex, TInVertex>
    {
        ...
        TTargetQuery IInEGremlinQuery<TElement, TInVertex>.As<TTargetQuery>(Func<IInEGremlinQuery<TElement, TInVertex>, StepLabel<IEGremlinQuery<TElement, TInVertex>, TElement>, TTargetQuery> continuation) => As(continuation);
        ...
        IEGremlinQuery<TNewElement> IEGremlinQuery.Cast<TNewElement>() => Cast<TNewElement>();
        ...
        IVGremlinQuery<IVertex> IEGremlinQuery.OutV() => AddStep<IVertex, Unit, Unit, Unit, Unit>(OutVStep.Instance);
