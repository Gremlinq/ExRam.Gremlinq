    ...
    public abstract class GroovySerializationTest
    {
        ...
        public void AddE_from_StepLabel()
        {
            _g
                ...
                .As((_, c) => _
                    ...
                    .From(c))
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).as(_d).addV(_e).property(single, _f, _g).addE(_h).from(_d).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void AddE_from_traversal()
        {
            ...
            _g
                ...
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).property(single, _d, _e).property(single, _f, _g).property(single, _h, _i).addE(_j).from(__.V().hasLabel(_k).has(_l, _m)).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void AddE_InV()
        {
            _g
                ...
                .InV()
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).property(single, _d, _e).property(single, _f, _g).addE(_h).to(__.V(_i).hasLabel(_j)).inV().project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))");
        }
        ...
        public void AddE_OutV()
        {
            _g
                ...
                .OutV()
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).property(single, _d, _e).property(single, _f, _g).addE(_h).to(__.V(_i).hasLabel(_j)).outV().project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))");
        }
        ...
        public void AddE_property()
        {
            _g
                ...
                .To(__ => __
                    .V<Country>("id"))
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).property(single, _d, _e).property(single, _f, _g).addE(_h).property(_i, _j).to(__.V(_k).hasLabel(_l)).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())");
        }
        ...
        public void AddE_to_StepLabel()
        {
            _g
                ...
                .As((_, l) => _
                    ...
                    .To(l))
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).as(_d).addV(_e).property(single, _f, _g).addE(_h).to(_d).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void AddE_to_traversal()
        {
            ...
            _g
                ...
                .To(__ => __
                    ...
                    .Where(t => t.CountryCallingCode == "+49"))
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).property(single, _d, _e).property(single, _f, _g).property(single, _h, _i).addE(_j).to(__.V().hasLabel(_k).has(_l, _m)).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
                .WithParameters("Person", "Age", 0, "Gender", 0, "Name", "Bob", "RegistrationDate", now, "LivesIn", "Country", "CountryCallingCode", "+49");
        }
        ...
        public void AddE_With_Ignored()
        {
            ...
            _g
               ...
               .Should()
               .SerializeToGroovy("addE(_a).property(_b, _c).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void AddV()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("addV(_a).property(id, _b).property(single, _c, _d).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_with_enum_property()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).property(single, _d, _e).property(id, _f).property(single, _g, _h).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_with_enum_property_with_workaround()
        {
            _g
                ...
                .AddV(new Person { Id = 1, Gender = Gender.Female })
                .Should()
                .SerializeToGroovy("addV(_a).property(id, _b).property(single, _c, _d).property(single, _e, _f).property(single, _g, _h).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_With_Ignored()
        {
            ...
            _g
               ...
               .AddV(person)
               .Should()
               .SerializeToGroovy("addV(_a).property(single, _b, _c).property(single, _d, _e).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_with_ignored_property()
        {
            _g
                ...
                .AddV(new Language { Id = 1, IetfLanguageTag = "en" })
                .Should()
                .SerializeToGroovy("addV(_a).property(id, _b).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_with_Meta_with_properties()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("addV(_a).property(id, _b).property(single, _c, _d, _e, _f, _g, _h).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_with_MetaModel()
        {
           _g
                ...
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).property(id, _d).property(list, _e, _f, _g, _h).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_with_multi_property()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).property(id, _d).property(list, _e, _f).property(list, _e, _g).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_ignores_label()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("addV(_a).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void AddV_without_id()
        {
            _g
                .AddV(new Language { IetfLanguageTag = "en" })
                .Should()
                .SerializeToGroovy("addV(_a).property(single, _b, _c).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
            ...
            _g
                ...
                .And(
                    ...
                    __ => __
                        .OutE<LivesIn>())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).and(__.inE(_b), __.outE(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void And_identity()
        {
            _g
                ...
                .And(
                    __ => __)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                    ...
                    __ => __
                        .And(
                            ...
                            ___ => ___
                                .OutE<WorksFor>()))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).and(__.outE(_b), __.inE(_c), __.outE(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void And_nested_or_optimization()
        {
            _g
                ...
                .And(
                    ...
                    __ => __.Out())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).and(__.out()).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person");
        }
        ...
        public void And_none()
        {
            _g
                ...
                .And(
                    __ => __.None())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).not(__.identity()).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person");
        }
        ...
        public void As_explicit_label1()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).as(_b).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void As_explicit_label2()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).as(_b, _c).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Drop()
        {
            _g
                ...
                .Drop()
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).drop().project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person");
        }
        ...
        public void E_of_concrete_type()
        {
            _g
                .E<WorksFor>()
                .Should()
                .SerializeToGroovy("E().hasLabel(_a).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void FilterWithLambda()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).filter({it.property('str').value().length() == 2}).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person");
        }
            ...
            _g
                ...
                .Or(
                    ...
                    __ => __
                        .OutE<LivesIn>())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).or(__.inE(_b), __.outE(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "WorksFor", "LivesIn");
        }
                    ...
                    __ => __
                        .Or(
                            ...
                            ___ => ___
                                .OutE<WorksFor>()))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).or(__.outE(_b), __.inE(_c), __.outE(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "LivesIn", "WorksFor");
        }
            ...
            _g
                ...
                .Or(
                    ...
                    __ => __
                        .OutE())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).or(__.outE()).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person");
        }
        ...
        public void OrderBy_lambda()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by({it.property('str').value().length()}).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person");
        }
        ...
        public void OrderBy_member()
        {
            _g
                ...
                .Order(b => b
                    .By(x => x.Name))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(_b, incr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void OrderBy_member_ThenBy_member()
        {
            _g
                ...
                .Order(b => b
                    ...
                    .By(x => x.Age))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(_b, incr).by(_c, incr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void OrderBy_ThenBy_lambda()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by({it.property('str1').value().length()}).by({it.property('str2').value().length()}).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person");
        }
        ...
        public void OrderBy_ThenByDescending_member()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(_b, incr).by(_c, decr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Name", "Age");
        }
        ...
        public void OrderBy_ThenByDescending_traversal()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(__.values(_b), incr).by(_c, decr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void OrderBy_traversal()
        {
            _g
                ...
                .Order(b => b
                    .By(__ => __.Values(x => x.Name)))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(__.values(_b), incr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Name");
        }
        ...
        public void OrderBy_traversal_ThenBy()
        {
            _g
                ...
                .Order(b => b
                    ...
                    .By(__ => __.Gender))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(__.values(_b), incr).by(_c, incr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Name", "Gender");
        }
        ...
        public void OrderBy_traversal_ThenBy_traversal()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(__.values(_b), incr).by(__.values(_c), incr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Name", "Gender");
        }
        ...
        public void OrderByDescending_member()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(_b, decr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Name");
        }
        ...
        public void OrderByDescending_traversal()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).order().by(__.values(_b), decr).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Name");
        }
...
#pragma warning restore 252,253
        ...
        public void Property_list()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V(_a).hasLabel(_b).property(list, _c, _d).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Property_null()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V(_a).hasLabel(_b).sideEffect(__.properties(_c).drop()).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Property_single()
        {
            _g
                ...
                .Property(x => x.Age, 36)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).property(single, _b, _c).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Repeat_Out()
        {
            _g
                ...
                .Repeat(__ => __
                    ...
                    .OfType<Person>())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).repeat(__.out(_b).hasLabel(_a)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "WorksFor");
        }
        ...
        public void ReplaceE()
        {
            ...
            _g
                .ReplaceE(worksFor)
                .Should()
                .SerializeToGroovy("E(_a).hasLabel(_b).sideEffect(__.properties(_c, _d, _e).drop()).property(_c, _f).property(_d, _g).property(_e, _f).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void ReplaceV_With_Config()
        {
            ...
            _g
                ...
                .ReplaceV(person)
                .Should()
                .SerializeToGroovy("V(_a).hasLabel(_b).sideEffect(__.properties(_c, _d, _e).drop()).property(single, _c, _f).property(single, _d, _g).property(single, _e, _h).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Select()
        {
            ...
            _g
                ...
                .Select(stepLabel)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).as(_b).select(_b).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "l1");
        }
        ...
        public void StepLabel_of_array_contains_element()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("inject(_a, _b, _c).fold().as(_d).V().hasLabel(_e).has(_f, __.where(within(_d))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Update_Vertex_And_Edge_No_Config()
        {
            ...
            _g
                ...
                .Update(worksFor)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).sideEffect(__.properties(_b, _c, _d, _e).drop()).property(single, _b, _f).property(single, _c, _g).property(single, _d, _h).property(single, _e, _i).outE(_j).sideEffect(__.properties(_k, _l, _m).drop()).property(_k, _n).property(_l, _o).property(_m, _n).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void Update_Vertex_And_Edge_With_Config()
        {
            ...
            _g
                ...
                .Update(worksFor)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).sideEffect(__.properties(_b, _c).drop()).property(single, _b, _d).property(single, _c, _e).outE(_f).sideEffect(__.properties(_g).drop()).property(_g, _h).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void UpdateE_With_Ignored()
        {
            ...
            _g
                ...
                .Should()
                .SerializeToGroovy("E().hasLabel(_a).sideEffect(__.properties(_b).drop()).property(_b, _c).project('id', 'label', 'properties').by(id).by(label).by(__.valueMap())")
        ...
        public void UpdateV_No_Config()
        {
            ...
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).sideEffect(__.properties(_b, _c, _d, _e).drop()).property(single, _b, _f).property(single, _c, _g).property(single, _d, _h).property(single, _e, _i).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void UpdateV_With_Ignored()
        {
            ...
            _g
                ...
                .Update(person)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).sideEffect(__.properties(_b, _c).drop()).property(single, _b, _d).property(single, _c, _e).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_array_does_not_intersect_property_array()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).not(__.has(_b, within(_c, _d))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_array_intersects_property_aray()
        {
            _g
                ...
                .Where(t => new[] { "+4912345", "+4923456" }.Intersect(t.PhoneNumbers).Any())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, within(_c, _d)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Company", "PhoneNumbers", "+4912345", "+4923456");
        }
        ...
        public void Where_bool_property_explicit_comparison1()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, _c).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_bool_property_implicit_comparison2()
        {
            _g
                ...
                .Where(t => !t.Enabled)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).not(__.has(_b, _c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("TimeFrame", "Enabled", true);
        }
        ...
        public void Where_complex_logical_expression()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, _c).has(_d, eq(_e).or(eq(_f))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_complex_logical_expression_with_null()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).hasNot(_b).has(_c, eq(_d).or(eq(_e))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_conjunction()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, eq(_c).and(eq(_d))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_conjunction_with_different_fields()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, _c).has(_d, _e).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_converted_Id_equals_constant()
        {
            _g
                ...
                .Where(t => (int)t.Id == 1)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(id, _b).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Language", 1);
        }
        ...
        public void Where_current_element_equals_stepLabel()
        {
            ...
            _g
                ...
                .Where(l2 => l2 == l)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).as(_b).V().hasLabel(_a).where(eq(_b)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_disjunction()
        {
            _g
                ...
                .Where(t => t.Age == 36 || t.Age == 42)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, eq(_c).or(eq(_d))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36, 42);
        }
        ...
        public void Where_disjunction_with_different_fields()
        {
            _g
                ...
                .Where(t => t.Name.Value == "Some name" || t.Age == 42)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).or(__.has(_b, _c), __.has(_d, _e)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Name", "Some name", "Age", 42);
        }
        ...
        public void Where_has_conjunction_of_three()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, eq(_c).and(eq(_d)).and(eq(_e))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_has_disjunction_of_three()
        {
            _g
                ...
                .Where(t => t.Age == 36 || t.Age == 42 || t.Age == 99)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, eq(_c).or(eq(_d)).or(eq(_e))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36, 42, 99);
        }
...
#pragma warning restore 252,253
        ...
        public void Where_property_array_contains_stepLabel()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("inject(_a).as(_b).V().hasLabel(_c).has(_d, __.where(eq(_b))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_array_intersects_stepLabel()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("inject(_a).fold().as(_b).V().hasLabel(_c).has(_d, __.where(within(_b))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("+4912345", "l1", "Company", "PhoneNumbers");
        }
        ...
        public void Where_property_array_is_empty()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).not(__.has(_b)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_array_is_not_empty()
        {
            _g
                ...
                .Where(t => t.PhoneNumbers.Any())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Company", "PhoneNumbers");
        }
        ...
        public void Where_property_contains_constant_with_TextP_support()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, containing(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_ends_with_constant_with_TextP_support()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, endingWith(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_equals_stepLabel()
        {
            ...
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).values(_b).as(_c).V().hasLabel(_a).has(_b, __.where(eq(_c))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_is_contained_in_array()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, within(_c, _d, _e)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_is_greater_or_equal_than_constant()
        {
            _g
                ...
                .Where(t => t.Age >= 36)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, gte(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36);
        }
        ...
        public void Where_property_is_greater_than_constant()
        {
            _g
                ...
                .Where(t => t.Age > 36)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, gt(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36);
        }
        ...
        public void Where_property_is_greater_than_or_equal_stepLabel()
        {
            ...
            _g
                ...
                .Where(l2 => l2.Age >= a)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).values(_b).as(_c).V().hasLabel(_a).has(_b, __.where(gte(_c))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_is_greater_than_stepLabel()
        {
            ...
            _g
                ...
                .Where(l2 => l2.Age > a)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).values(_b).as(_c).V().hasLabel(_a).has(_b, __.where(gt(_c))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", "l1");
        }
        ...
        public void Where_property_is_lower_or_equal_than_constant()
        {
            _g
                ...
                .Where(t => t.Age <= 36)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, lte(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36);
        }
        ...
        public void Where_property_is_lower_than_constant()
        {
            _g
                ...
                .Where(t => t.Age < 36)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, lt(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36);
        }
        ...
        public void Where_property_is_lower_than_or_equal_stepLabel()
        {
            ...
            _g
                ...
                .Where(l2 => l2.Age <= a)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).values(_b).as(_c).V().hasLabel(_a).has(_b, __.where(lte(_c))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", "l1");
        }
        ...
        public void Where_property_is_lower_than_stepLabel()
        {
            ...
            _g
                ...
                .Where(l2 => l2.Age < a)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).values(_b).as(_c).V().hasLabel(_a).has(_b, __.where(lt(_c))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", "l1");
        }
        ...
        public void Where_property_is_not_contained_in_array()
        {
            _g
                ...
                .Where(t => !new[] { 36, 37, 38 }.Contains(t.Age))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).not(__.has(_b, within(_c, _d, _e))).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36, 37, 38);
        }
        ...
        public void Where_property_is_not_present()
        {
            _g
                ...
                .Where(t => t.Name == null)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).hasNot(_b).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Name");
        }
        ...
        public void Where_property_is_prefix_of_constant()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, within(_c, _d, _e, _f, _g, _h, _i)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_is_prefix_of_empty_string()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, within(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Country", "CountryCallingCode", "");
        }
        ...
        public void Where_property_not_equals_constant()
        {
            _g
                ...
                .Where(t => t.Age != 36)
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, neq(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36);
        }
        ...
        public void Where_property_starts_with_constant_with_TextP_support()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, startingWith(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
        ...
        public void Where_property_starts_with_constant_without_TextP_support()
        {
            _g
                ...
                .Where(c => c.CountryCallingCode.StartsWith("+49123"))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, between(_c, _d)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
            ...
            _g
                ...
                .Where(
                    ...
                    _ => _
                        .Inject(36))
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).has(_b, __.inject(_c)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "Age", 36);
        }
        ...
        public void Where_traversal()
        {
            _g
                ...
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).where(__.out(_b)).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person", "LivesIn");
        }
        ...
        public void Where_traversal_untyped()
        {
            ...
            g
                .Where(_ => _.Count())
                .Should()
                .SerializeToGroovy("V().hasLabel(_a).where(__.count()).project('id', 'label', 'properties').by(id).by(label).by(__.properties().group().by(label).by(__.project('id', 'label', 'value', 'properties').by(id).by(label).by(value).by(__.valueMap())))")
                .WithParameters("Person");
        }
