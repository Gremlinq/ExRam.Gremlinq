...
namespace ExRam.Gremlinq.Core.Deserialization
{
    ...
    {
        private sealed class EmptyDeserializerExceptionTransformer : ITransformer
        {
            public ITransformer Add(IConverterFactory converterFactory) => Transformer.Empty.Add(converterFactory);
        ...
        public static readonly ITransformer Default = new EmptyDeserializerExceptionTransformer();
    }
}
