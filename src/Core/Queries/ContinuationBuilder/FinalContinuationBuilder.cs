...
namespace ExRam.Gremlinq.Core
{
        ...
        where TOuterQuery : GremlinQueryBase, IGremlinQueryBase
    {
        ...
        public TNewTargetQuery BuildAs<TNewTargetQuery>() where TNewTargetQuery : IStartGremlinQuery => GremlinQueryBase.CloneAs<TNewTargetQuery>(_outer.Environment, _steps, _labelProjections, _metadata);
