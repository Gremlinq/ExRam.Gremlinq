...
namespace ExRam.Gremlinq.Core
{
    partial class GremlinQuery<T1, T2, T3, T4, TMeta, TFoldedQuery>
    {
        ...
        private ContinuationBuilder<GremlinQuery<T1, T2, T3, T4, TMeta, TFoldedQuery>, GremlinQuery<T1, T2, T3, T4, TMeta, TFoldedQuery>> Continue(ContinuationFlags flags = ContinuationFlags.None) => new(
            this,
            new GremlinQuery<T1, T2, T3, T4, TMeta, TFoldedQuery>(Environment, Traversal.Empty.WithProjection(Steps.Projection), LabelProjections, Metadata), flags);
