...
namespace ExRam.Gremlinq.Core
{
    partial class GremlinQuery<T1, T2, T3, T4, T5, TFoldedQuery>
    {
        ...
        private ContinuationBuilder<GremlinQuery<T1, T2, T3, T4, T5, TFoldedQuery>, GremlinQuery<T1, T2, T3, T4, T5, TFoldedQuery>> Continue(ContinuationFlags flags = ContinuationFlags.None) => new(
            this,
            new GremlinQuery<T1, T2, T3, T4, T5, TFoldedQuery>(Environment, Traversal.Empty.WithProjection(Steps.Projection), LabelProjections, Metadata), flags);
