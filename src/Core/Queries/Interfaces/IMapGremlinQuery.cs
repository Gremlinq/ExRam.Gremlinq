...
namespace ExRam.Gremlinq.Core
{
    ...
    {
        /// <summary>
        /// Select a single value from the map/tuple by projection expression.
        /// Corresponds to the Gremlin <c>select()</c> step.
        /// </summary>
        /// <typeparam name="TValue">The type of the selected value.</typeparam>
        /// <param name="projection">An expression selecting the value from the map.</param>
        ...
        /// <summary>
        /// Select multiple values from the map/tuple by projection expressions, returning a tuple.
        /// Corresponds to the Gremlin <c>select()</c> step with multiple keys.
        /// </summary>
        /// <seealso href="https://tinkerpop.apache.org/docs/current/reference/#select-step">Reference Documentation - Select Step</seealso>
        ...
        /// <inheritdoc cref="Select{TItem1, TItem2}(Expression{Func{TElement, TItem1}}, Expression{Func{TElement, TItem2}})" />
