...
namespace ExRam.Gremlinq.Core
{
    ...
    internal abstract partial class GremlinQueryBase<T1, T2, T3, T4> : GremlinQueryBase
    {
        protected GremlinQueryBase(
            IGremlinQueryEnvironment environment,
            Traversal steps,
        ...
        private GremlinQueryBase<TEdge, T1, object, IGremlinQueryBase> AddE<TEdge>(TEdge newEdge) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<T1, T2, T3, T4> AddOrUpdate(T1 element, bool add)
        {
            var ret = this;
            var props = element
                .Serialize(
        ...
        private GremlinQueryBase<TVertex, object, object, IGremlinQueryBase> AddV<TVertex>(TVertex vertex) => this
            .Continue()
            .Build(
        ...
        private TTargetQuery Aggregate<TStepLabel, TTargetQuery>(Scope scope, Func<GremlinQueryBase<T1, T2, T3, T4>, TStepLabel, TTargetQuery> continuation)
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Aggregate<TStepLabel>(Scope scope, TStepLabel stepLabel)
        ...
        private GremlinQueryBase<T1, T2, T3, T4> And<TState>(Func<GremlinQueryBase<T1, T2, T3, T4>, TState, IGremlinQueryBase> continuation1, Func<GremlinQueryBase<T1, T2, T3, T4>, TState, IGremlinQueryBase> continuation2, TState state) => And(this
            .Continue(ContinuationFlags.Filter)
            .With(continuation1, state)
            .With(continuation2, state));

        private GremlinQueryBase<T1, T2, T3, T4> And(Func<GremlinQueryBase<T1, T2, T3, T4>, IGremlinQueryBase>[] continuations) => And(this
            .Continue(ContinuationFlags.Filter)
            .With(continuations));

        private static GremlinQueryBase<T1, T2, T3, T4> And(MultiContinuationBuilder<GremlinQueryBase<T1, T2, T3, T4>, GremlinQueryBase<T1, T2, T3, T4>> continuationBuilder) => continuationBuilder
        ...
        private TTargetQuery As<TStepLabel, TTargetQuery>(Func<GremlinQueryBase<T1, T2, T3, T4>, TStepLabel, TTargetQuery> continuation)
            where TStepLabel : StepLabel, new()
            where TTargetQuery : IGremlinQueryBase
        {
        ...
        private GremlinQueryBase<T1, T2, T3, T4> As(StepLabel stepLabel) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> Both() => this
            .Continue()
            .Build(static builder => builder
                .AddStep(BothStep.NoLabels)
                .AsAuto());

        private GremlinQueryBase<object, object, object, IGremlinQueryBase> Both<TEdge>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> BothE() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<TEdge, object, object, IGremlinQueryBase> BothE<TEdge>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<TTarget, object, object, IGremlinQueryBase> BothV<TTarget>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<TSelectedElement, TArrayItem, object, TQuery> Cap<TSelectedElement, TArrayItem, TQuery>(StepLabel<IArrayGremlinQuery<TSelectedElement, TArrayItem, TQuery>, TSelectedElement> stepLabel) where TQuery : IGremlinQueryBase => this
            .Continue()
            .Build(
                static (builder, stepLabel) => builder
        ...
        private TTargetQuery Choose<TTrueQuery, TFalseQuery, TTargetQuery>(Expression<Func<T1, bool>> predicate, Func<GremlinQueryBase<T1, T2, T3, T4>, TTrueQuery> trueChoice, Func<GremlinQueryBase<T1, T2, T3, T4>, TFalseQuery>? maybeFalseChoice = default)
        ...
        private TTargetQuery Choose<TTrueQuery, TFalseQuery, TTargetQuery>(Func<GremlinQueryBase<T1, T2, T3, T4>, IGremlinQueryBase> traversalPredicate, Func<GremlinQueryBase<T1, T2, T3, T4>, TTrueQuery> trueChoice, Func<GremlinQueryBase<T1, T2, T3, T4>, TFalseQuery>? maybeFalseChoice = default)
            where TTrueQuery : IGremlinQueryBase
            where TFalseQuery : IGremlinQueryBase
            where TTargetQuery : IGremlinQueryBase => this
                .Continue()
        ...
        private TTargetQuery Choose<TTrueQuery, TFalseQuery, TTargetQuery>(Traversal chooseTraversal, Func<GremlinQueryBase<T1, T2, T3, T4>, TTrueQuery> trueChoice, Func<GremlinQueryBase<T1, T2, T3, T4>, TFalseQuery>? maybeFalseChoice = default)
            where TTrueQuery : IGremlinQueryBase
            where TFalseQuery : IGremlinQueryBase
            where TTargetQuery : IGremlinQueryBase => this
                .Continue()
        ...
        private TTargetQuery Choose<TTargetQuery>(Func<IChooseBuilder<GremlinQueryBase<T1, T2, T3, T4>>, IChooseBuilderWithCaseOrDefault<TTargetQuery>> continuation)
            where TTargetQuery : IGremlinQueryBase
        {
            return continuation(new ChooseBuilder<GremlinQueryBase<T1, T2, T3, T4>, object>(this)).TargetQuery;
        }

        private TReturnQuery Coalesce<TTargetQuery, TReturnQuery>(params Func<GremlinQueryBase<T1, T2, T3, T4>, TTargetQuery>[] continuations)
            where TTargetQuery : IGremlinQueryBase
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Coin(double probability) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<TValue, object, object, IGremlinQueryBase> Constant<TValue>(TValue constant) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<long, object, object, IGremlinQueryBase> Count(Scope scope) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<long, object, object, IGremlinQueryBase> CountGlobal() => Count(Scope.Global);

        private GremlinQueryBase<long, object, object, IGremlinQueryBase> CountLocal() => Count(Scope.Local);

        private GremlinQueryBase<T1, T2, T3, T4> CyclicPath() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> DedupGlobal() => this
            .Continue()
            .Build(static builder => builder
                .AddStep(DedupStep.Global));

        private GremlinQueryBase<T1, T2, T3, T4> DedupLocal() => this
            .Continue()
            .Build(static builder => builder
                .AddStep(DedupStep.Local));

        private GremlinQueryBase<object, object, object, IGremlinQueryBase> Drop() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> DropProperties(string key) => this
            .SideEffect(_ => _
                .Properties<object, object, object>(
                    Projection.Empty,
                    [key])
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> E(ImmutableArray<object> ids) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<string, object, object, IGremlinQueryBase> Explain() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> Fail(string? message = null) => this
            .Continue()
            .Build(
        ...
        private TTargetQuery FlatMap<TTargetQuery>(Func<GremlinQueryBase<T1, T2, T3, T4>, TTargetQuery> continuation) where TTargetQuery : IGremlinQueryBase => this
            .Continue()
            .With(continuation)
        ...
        private GremlinQueryBase<T1[], T1, object, TNewFoldedQuery> Fold<TNewFoldedQuery>() where TNewFoldedQuery : IGremlinQueryBase => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, object, object, IGremlinQueryBase> ForceElement() => this
            .Continue()
            .Build(static builder => builder
                .WithNewProjection(static _ => _.Highest(Projection.Element))
                .AsAuto<T1>());

        private GremlinQueryBase<T1, TNewOutVertex, TInVertex, IGremlinQueryBase> From<TNewOutVertex, TInVertex>(Func<GremlinQueryBase<TInVertex, T2, T3, T4>, IVertexGremlinQueryBase<TNewOutVertex>> fromVertexContinuation) => this
        ...
        private GremlinQueryBase<TNewElement, TNewOutVertex, TNewInVertex, IGremlinQueryBase> From<TNewElement, TNewOutVertex, TNewInVertex>(StepLabel<TNewOutVertex> label) => this
           .Continue()
           .Build(
        ...
        private IMapGremlinQuery<IDictionary<TKey, TValue>> Group<TKey, TValue>(Func<IGroupBuilder<GremlinQueryBase<T1, T2, T3, T4>>, IGroupBuilderWithKeyAndValue<TKey, TValue>> projection) =>
            projection(new GroupBuilder<object, object>(Continue())).Build();

        private IMapGremlinQuery<IDictionary<TKey, T1[]>> Group<TKey>(Func<IGroupBuilder<GremlinQueryBase<T1, T2, T3, T4>>, IGroupBuilderWithKey<IGremlinQueryBase<T1>, TKey>> projection) => new GroupBuilder<object, object>(Continue())
            .Map(projection)
            .ByValue(__ => __
                .Cast<T1>()
                .Fold())
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> Id() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Identity() => this
            .Continue()
            .Build(static builder => builder
                .AddStep(IdentityStep.Instance));

        private GremlinQueryBase<object, object, object, IGremlinQueryBase> In() => this
            .Continue()
            .Build(static builder => builder
                .AddStep(InStep.NoLabels)
                .AsAuto());

        private GremlinQueryBase<object, object, object, IGremlinQueryBase> In<TEdge>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> InE() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<TEdge, object, T1, IGremlinQueryBase> InE<TEdge>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<TNewElement, T2, T3, T4> Inject<TNewElement>(IEnumerable<TNewElement> elements) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<TNewElement, object, object, IGremlinQueryBase> InOutV<TNewElement>(Step step) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<TNewElement, object, object, IGremlinQueryBase> InV<TNewElement>() => InOutV<TNewElement>(InVStep.Instance);

        private GremlinQueryBase<string, object, object, IGremlinQueryBase> Key() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<string, object, object, IGremlinQueryBase> Label() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> LimitGlobal(long count) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<T1, T2, T3, T4> LimitLocal(long count) => this
            .Continue()
            .Build(
                static (builder, count) => builder
                    .AddStep(count == 1
        ...
        private TTargetQuery Local<TTargetQuery>(Func<GremlinQueryBase<T1, T2, T3, T4>, TTargetQuery> localTraversal) where TTargetQuery : IGremlinQueryBase => this
            .Continue()
            .With(localTraversal)
        ...
        private TTargetQuery Map<TTargetQuery>(Func<GremlinQueryBase<T1, T2, T3, T4>, TTargetQuery> continuation) where TTargetQuery : IGremlinQueryBase => this
            .Continue()
            .With(continuation)
        ...
        private GremlinQueryBase<T1, T2, T3, T4> MaxGlobal() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> MeanGlobal() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> MinGlobal() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> None() => this
            .Continue()
            .Build(static builder => builder
                .None());

        private GremlinQueryBase<T1, T2, T3, T4> Not<TState>(Func<GremlinQueryBase<T1, T2, T3, T4>, TState, IGremlinQueryBase> continuation, TState state) => this
            .Continue()
        ...
        private TTargetQuery Optional<TTargetQuery>(Func<GremlinQueryBase<T1, T2, T3, T4>, TTargetQuery> optionalTraversal) where TTargetQuery : IGremlinQueryBase => this
            .Continue()
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Or<TState>(Func<GremlinQueryBase<T1, T2, T3, T4>, TState, IGremlinQueryBase> continuation1, Func<GremlinQueryBase<T1, T2, T3, T4>, TState, IGremlinQueryBase> continuation2, TState state) => Or(this
            .Continue(ContinuationFlags.Filter)
            .With(continuation1, state)
            .With(continuation2, state));

        private GremlinQueryBase<T1, T2, T3, T4> Or(Func<GremlinQueryBase<T1, T2, T3, T4>, IGremlinQueryBase>[] continuations) => Or(this
            .Continue(ContinuationFlags.Filter)
            .With(continuations));

        private static GremlinQueryBase<T1, T2, T3, T4> Or(MultiContinuationBuilder<GremlinQueryBase<T1, T2, T3, T4>, GremlinQueryBase<T1, T2, T3, T4>> continuationBuilder) => continuationBuilder
            .Build(static (builder, traversals) =>
            {
                if (traversals.Length == 0)
                    throw new ArgumentException("Expected at least 1 sub-query.");
        ...
        private GremlinQueryBase<TTarget, object, object, IGremlinQueryBase> OtherV<TTarget>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> Out() => this
            .Continue()
            .Build(static builder => builder
                .AddStep(OutStep.NoLabels)
                .AsAuto());

        private GremlinQueryBase<object, object, object, IGremlinQueryBase> Out<TEdge>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> OutE() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<TEdge, T1, object, IGremlinQueryBase> OutE<TEdge>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<TNewElement, object, object, IGremlinQueryBase> OutV<TNewElement>() => InOutV<TNewElement>(OutVStep.Instance);

        private GremlinQueryBase<Path, object, object, IGremlinQueryBase> Path() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<string, object, object, IGremlinQueryBase> Profile() => this
            .Continue()
            .Build(static builder => builder
        ...
        private IMapGremlinQuery<TResult> Project<TResult>(Func<IProjectBuilder<GremlinQueryBase<T1, T2, T3, T4>, T1>, IProjectMapResult<TResult>> continuation)
        {
        ...
        private IGremlinQuery<dynamic> Project(Func<IProjectBuilder<GremlinQueryBase<T1, T2, T3, T4>, T1>, IProjectDynamicResult> continuation)
        {
            return new ProjectBuilder(this)
                .Map(continuation)
                .Build();
        ...
        private IMapGremlinQuery<TResult> Project<TResult>(Func<IProjectBuilder<GremlinQueryBase<T1, T2, T3, T4>, T1>, IProjectTupleResult<TResult>> continuation)
        ...
        private GremlinQueryBase<TNewElement, TNewPropertyValue, TNewMeta, IGremlinQueryBase> Properties<TNewElement, TNewPropertyValue, TNewMeta>(Projection projection, params Expression[] projections) => Properties<TNewElement, TNewPropertyValue, TNewMeta>(
            projection,
            projections
                .Select(projection => GetKey(projection).RawKey)
                .OfType<string>());

        private GremlinQueryBase<TNewElement, TNewPropertyValue, TNewMeta, IGremlinQueryBase> Properties<TNewElement, TNewPropertyValue, TNewMeta>(Projection projection, IEnumerable<string> keys) => this
            .Continue()
            .Build(
                static (builder, tuple) => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Property(LambdaExpression projection, object? value) => Property(GetKey(projection), value);

        private GremlinQueryBase<T1, T2, T3, T4> Property(Key key, object? value) => this
            .Continue()
            .Build(
                static (builder, tuple) =>
                {
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Property(Key key, Func<GremlinQueryBase<T1, T2, T3, T4>, IGremlinQueryBase> valueContinuation) => this
            .Continue()
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Property(LambdaExpression projection, Func<GremlinQueryBase<T1, T2, T3, T4>, IGremlinQueryBase> valueContinuation) => this
            .Continue()
            .With(valueContinuation)
            .Build(
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Range(long low, long high, Scope scope) => this
            .Continue()
            .Build(
                static (builder, tuple) => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> RangeGlobal(long low, long high) => Range(low, high, Scope.Global);

        private GremlinQueryBase<T1, T2, T3, T4> RangeLocal(long low, long high) => Range(low, high, Scope.Local);
        ...
        private GremlinQueryBase<T1, T2, T3, T4> SideEffect(Func<GremlinQueryBase<T1, T2, T3, T4>, IGremlinQueryBase> sideEffectContinuation) => this
            .Continue()
            .With(sideEffectContinuation)
            .Build(static (builder, traversal) => builder
                .AddStep(new SideEffectStep(traversal)));

        private GremlinQueryBase<T1, T2, T3, T4> SimplePath() => this
            .Continue()
            .Build(static builder => builder
                .AddStep(SimplePathStep.Instance));

        private GremlinQueryBase<T1, T2, T3, T4> Skip(long count, Scope scope) => this
            .Continue()
            .Build(
                static (builder, tuple) => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> SumGlobal() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> TailGlobal(long count) => this
            .Continue()
            .Build(
                static (builder, count) => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> TailLocal(long count) => this
            .Continue()
            .Build(
                static (builder, count) => builder
                    .AddStep(count == 1
        ...
        private GremlinQueryBase<T1, TOutVertex, TNewInVertex, IGremlinQueryBase> To<TOutVertex, TNewInVertex>(Func<GremlinQueryBase<TOutVertex, T2, T3, T4>, IVertexGremlinQueryBase<TNewInVertex>> toVertexContinuation) => this
        ...
        private GremlinQueryBase<TNewElement, TNewOutVertex, TNewInVertex, IGremlinQueryBase> To<TNewElement, TNewOutVertex, TNewInVertex>(StepLabel stepLabel) => this
            .Continue()
            .Build(
                static (builder, stepLabel) => builder
        ...
        private GremlinQueryBase<Tree<TRoot>, object, object, IGremlinQueryBase> Tree<TRoot>() where TRoot : notnull => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Unfold() => this
            .Continue()
            .Build(static builder => builder
        ...
        private TTargetQuery Union<TTargetQuery>(params Func<GremlinQueryBase<T1, T2, T3, T4>, TTargetQuery>[] unionTraversals)
            where TTargetQuery : IGremlinQueryBase =>
            Union<TTargetQuery, TTargetQuery>(unionTraversals);

        private TReturnQuery Union<TTargetQuery, TReturnQuery>(params Func<GremlinQueryBase<T1, T2, T3, T4>, TTargetQuery>[] unionContinuations)
            where TTargetQuery : IGremlinQueryBase
            where TReturnQuery : IGremlinQueryBase => this
                .Continue()
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> V(ImmutableArray<object> ids) => this
            .Continue()
            .Build(
                static (builder, ids) => builder
        ...
        private GremlinQueryBase<TNewPropertyValue, object, object, IGremlinQueryBase> Value<TNewPropertyValue>() => this
            .Continue()
            .Build(static builder => builder
        ...
        private GremlinQueryBase<TNewElement, object, object, IGremlinQueryBase> ValueMap<TNewElement>(ImmutableArray<string> keys) => this
            .Continue()
            .Build(
        ...
        private GremlinQueryBase<TNewElement, object, object, IGremlinQueryBase> ValueMap<TNewElement>(IEnumerable<LambdaExpression> projections)
        {
        ...
        private GremlinQueryBase<TValue, object, object, IGremlinQueryBase> ValuesForKeys<TValue>(IEnumerable<Key> keys)
        {
            ...
            return stepsArray.Length switch
            {
                ...
                _ => this
                    .Union(stepsArray
                        .Select(static step => new Func<GremlinQueryBase<T1, T2, T3, T4>, GremlinQueryBase<TValue, object, object, IGremlinQueryBase>>(__ => __
                            .Continue()
                            .Build(
                                static (builder, step) => builder
                                    .AddStep(step)
        ...
        private GremlinQueryBase<TValue, object, object, IGremlinQueryBase> ValuesForProjections<TValue>(IEnumerable<LambdaExpression> projections) => ValuesForKeys<TValue>(projections.Select(GetKey));

        private GremlinQueryBase<VertexProperty<TNewPropertyValue, TNewMeta>, TNewPropertyValue, TNewMeta, IGremlinQueryBase> VertexProperties<TNewPropertyValue, TNewMeta>(Expression[] projections) => Properties<VertexProperty<TNewPropertyValue, TNewMeta>, TNewPropertyValue, TNewMeta>(Projection.VertexProperty, projections);

        private GremlinQueryBase<VertexProperty<TNewPropertyValue>, TNewPropertyValue, object, IGremlinQueryBase> VertexProperties<TNewPropertyValue>(Expression[] projections) => Properties<VertexProperty<TNewPropertyValue>, TNewPropertyValue, object>(Projection.VertexProperty, projections);

        private GremlinQueryBase<T1, T2, T3, T4> Where(Func<GremlinQueryBase<T1, T2, T3, T4>, IGremlinQueryBase> filterContinuation) => this
            .Continue(ContinuationFlags.Filter)
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Where(Expression expression)
        {
        ...
        private GremlinQueryBase<T1, T2, T3, T4> Where<TProjection>(Expression<Func<T1, TProjection>> predicate, Func<IGremlinQuery<TProjection>, IGremlinQueryBase> propertyContinuation) => predicate.RefersToParameter(out _) && predicate.Body is MemberExpression memberExpression
             ? this
                 .Continue()
                 .With(
        ...
        private GremlinQueryBase<object, object, object, IGremlinQueryBase> WithSideEffect<TSideEffect>(StepLabel<TSideEffect> label, TSideEffect value) => this
            .Continue()
            .Build(
                static (builder, tuple) => builder
                    .WithSteps(
