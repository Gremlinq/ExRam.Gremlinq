...
namespace ExRam.Gremlinq.Core
{
    ...
    {
        private sealed class ProjectBuilder : IProjectBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>
        {
            private readonly bool _emptyProjectionProtection;
            private readonly GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery> _sourceQuery;

            public ProjectBuilder(GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery> sourceQuery) : this(
                sourceQuery,
                sourceQuery.Environment.Options.GetValue(GremlinqOption.EnableEmptyProjectionValueProtection))
            {
            }

            private ProjectBuilder(GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery> sourceQuery, bool emptyProjectionProtection)
            {
                _sourceQuery = sourceQuery;
                _emptyProjectionProtection = emptyProjectionProtection;
            }

            IProjectBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1> IProjectBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>.WithEmptyProjectionProtection()
            {
                return new ProjectBuilder(_sourceQuery, true);
            }

            IProjectTupleBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1> IProjectBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>.ToTuple()
            {
                return Continue<object>();
            }

            IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1> IProjectBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>.ToDynamic()
            {
                return Continue<object>();
            }

            IProjectMapBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1, TTargetType> IProjectBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>.To<TTargetType>()
            {
        ...
        private sealed partial class ProjectBuilder<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6, TItem7, TItem8, TItem9, TItem10, TItem11, TItem12, TItem13, TItem14, TItem15, TItem16> :
            IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>,
            IProjectMapBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1, TItem1>
        {
            private readonly FastImmutableList<string> _names;
            private readonly Traversal _emptyProjectionProtectionDecoratorSteps;
            private readonly MultiContinuationBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>> _continuationBuilder;

            public ProjectBuilder(
                MultiContinuationBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>> continuationBuilder,
            ...
            IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1> IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>.By(Func<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, IGremlinQueryBase> projection)
            {
            ...
            IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1> IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>.By(string name, Func<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, IGremlinQueryBase> projection)
            {
            ...
            IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1> IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>.By(string name, Expression<Func<T1, object>> projection)
            {
            ...
            IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1> IProjectDynamicBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1>.By(Expression<Func<T1, object>> projection)
            {
            ...
            IProjectMapBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1, TItem1> IProjectMapBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1, TItem1>.By<TSourceProperty, TTargetProperty>(Expression<Func<TItem1, TTargetProperty>> targetExpression, Func<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, IGremlinQueryBase<TSourceProperty>> projection)
            {
                return By(
                    targetExpression,
            ...
            IProjectMapBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1, TItem1> IProjectMapBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1, TItem1>.By<TSourceProperty, TTargetProperty>(Expression<Func<TItem1, TTargetProperty>> targetExpression, Expression<Func<T1, TSourceProperty>> projection)
            {
                return By(
                    targetExpression,
            ...
            private IProjectMapBuilder<GremlinQuery<T1, T2, T3, TScalar, TMeta, TFoldedQuery>, T1, TItem1> By<TTargetProperty, TState>(Expression<Func<TItem1, TTargetProperty>> targetExpression, Func<ProjectBuilder<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6, TItem7, TItem8, TItem9, TItem10, TItem11, TItem12, TItem13, TItem14, TItem15, TItem16>, string, TState, ProjectBuilder<TItem1, TItem2, TItem3, TItem4, TItem5, TItem6, TItem7, TItem8, TItem9, TItem10, TItem11, TItem12, TItem13, TItem14, TItem15, TItem16>> transformation, TState state)
            {
