namespace ExRam.Gremlinq.Core.Serialization
{
    ...
    public delegate object? GremlinQueryFragmentSerializerDelegate<TFragment>(TFragment fragment, IGremlinQueryEnvironment environment, IGremlinQuerySerializer recurse);
}
